<nav class="flex fixed w-full z-20 top-0 start-0 border-b shadow-sm bg-white">
    <div class="max-w-screen-xl w-full flex flex-wrap items-center justify-between mx-auto p-3">
        ...
        <div class="flex lg:order-2 gap-3 rtl:space-x-reverse">
            <button class="navbar-burger inline-flex items-center lg:hidden text-amber-700 hover:text-amber-800 active:text-amber-900">
                <svg class="block h-4 w-4 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <title>Hamburguer</title>
                    <path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"></path>
                </svg>
            </button>
            <x-secondary-button class="hidden lg:inline-flex">
                <a href="{{ route('login') }}">
                    Entrar
                </a>
            </x-secondary-button>
            <x-button class="hidden lg:inline-flex">
    ...
    <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
        <div class="flex items-center mb-8">
            ...
            <button class="navbar-close">
                <svg class="h-6 w-6 cursor-pointer text-amber-700 hover:text-amber-800 active:text-amber-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
